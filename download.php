<!--
        This is a PHP file for Corvin site that is called by index.php to handle files being downloaded from Corvin.
...
$DownloadDirectory = "/../../home/joel/Castle/" . $User . "/" . $CurrentPathString;						/* Assign path of directory holding file		*/
