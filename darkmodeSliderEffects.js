...
function workspaceListStyleToDark(value, key) {
  if (value !== null && key > 0) {
...
function workspaceListStyleToLight(value, key) {
  if (value !== null && key > 0) {
...
function manualModeSwitch() {
  ...
  if (document.getElementById("darkmodeSlider").checked) {
    ...
    workspaces.forEach(workspaceListStyleToDark);
    ...
    workspaces.forEach(workspaceListStyleToLight);
