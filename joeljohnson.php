...
<div class = "TopBar">
	...
	<?php
		...
		echo "<img src = 'Images/Corvin Castle.png' alt = 'Corvin Castle' style = 'width:250px;'/>";
		echo "</a>";
    ?>
	</div>
    <div class = "User">
...
<div class = "DiskSpace">
	...
	<?php
        ...
        $FreeBytes = disk_free_space("/media/joel/RED DRIVE/Castle");
        $TotalBytes = disk_total_space("/media/joel/RED DRIVE/Castle");
...
<div id = "MainContent">
    ...
    <div id = "Directory">
            ...
            <?php
				...
				{
					$DirectoryPath = "/media/joel/RED DRIVE/Castle/" . $User[0] . "/" . implode("/", $CurrentPath) . "/";
                }
				else
				{
					$DirectoryPath = "/media/joel/RED DRIVE/Castle/" . $User[0] . "/" . $ReturnPathString . "/";
				}
