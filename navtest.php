...
class DirTree																								/* Defines the class DirTree													*/
{
    ...
    public function __construct($User, $Active)																/* Public method (function) of the class DirTree which is automatically called  */
	{																										/*  once an instance of this class is created (and object). The function takes  */
        ...
        if ($Active !== null)																				/* If active is not null														*/
		{
			...
			{
				$Display = substr($Active, 0, strlen($Active) - strpos(strrev($Active), '/') - 1);
