<!--
        This is a PHP file for Corvin site that is called by login.php to handle user login validation and rerouting to the correct user hub.
...
$UserDatabase = array(
	...
	array("lbiddle",	"Hungry4Apples?",		"Lauren",		"Biddle"	),				/*  ID information								*/
	array("Brandon",	"BWPassword",			"Brandon",		"Weigel"	),
	array("Josh",		"JHPassword",			"Josh",			"Hensley"	),
	array("Tyler",		"TKPassword",			"Tyler",		"Kelley"	),
	array("Example",	"EUPassword",			"Example",		"User"		),
	array("Jeff",		"1932Ford",				"Jeff",			"Johnson"	),
	array("Annette",	"Campfire",				"Annette",		"Lazzarotto"),
	array("JoelAmir",	"NAUGibbsLab",			"JoelAmir",		"Shared"	),
	array("Derek",		"DCPassword",			"Derek",		"Campbell"	),
	array("JGGibbs",	"NanoFab",				"Gibbs",		"Lab"		),
	array("Dylan",		"DNPassword",			"Dylan",		"Nicholls"	));
...
else
{
																								...
																								/*  password									*/
	{
		...
		echo "<meta http-equiv='Refresh' content='0; url = " . $User . ".php'>";				/* Redirect to the user's page, located at		*/
